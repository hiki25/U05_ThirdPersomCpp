...
UCBTTaskNode_ChageAction::UCBTTaskNode_ChageAction()
{
...
EBTNodeResult::Type UCBTTaskNode_ChageAction::ExecuteTask(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory)
{
...
void UCBTTaskNode_ChageAction::TickTask(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory, float DeltaSeconds)
{
